        ...
        <div class="modal-content">
            ...
            <form action='../admin/add-admin.php' method='POST' enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <input type="checkbox" onclick="myFunction('inputpass')">  Show Password
                </div>
                <!-- Modal Footer -->
        ...
        <div class="modal-content">
            ...
            <form action='../admin/edit-admin.php' method='POST' enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <br>
                    <div class="form-group row">
                        <label for="editpass" class="col-sm-5 col-form-label"><b>password</b></label>
                        <div class="col-sm-5">
                            <input type="password" class="form-control" id="editpass" name="password">
                        </div>
                    </div>
                    <input type="checkbox" onclick="myFunction('editpass')">  Show Password
                </div>
                <!-- Modal Footer -->
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"> Close </button>
